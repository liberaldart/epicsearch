...
const traverseForFieldThroughRightNode = (cache, pathType, leftNodeFieldInfo, leftNode, edgePathToRightNode, rightNode, callback) => {
  ...
  debug('traverse through right node field', rightNode._type, 'Left node', leftNode._type, ' for field', leftNodeFieldInfo.name, 'with dependencypath', relationWisePathsForDependency, 'and path to right node', relationWisePathToRightNode, 'path type', pathType)
