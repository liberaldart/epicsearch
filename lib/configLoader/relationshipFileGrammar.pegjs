...
relationDef
  = newLine* relationAB:word space* '<>'? space* relationBA:word? space* newLine connectedEntities:entityConnection+ {
    return {
      aToBName: relationAB,
      bToAName: relationBA,
...
entityConnection
  = space+ entityA:word space+ '<>' space+ entityB:word space* newLine? {
