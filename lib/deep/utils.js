...
const recalculateUnionInSibling = (field, entity, updatedEntity, relation, relatedEId, cache) => {
  ...
  .then(() => {
    //Read from cache since the relatedEntity may have been updaed within the cache in meantime
    //by parallel updates
