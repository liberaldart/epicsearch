 ...
 * @return {Object} - {entities: <list of leaf entities of the tree governed by the path from sourceEntity>, idToEdgePathMap: <map from id of entities to edge wise pathi, prepended with pathToPrepend
 */
