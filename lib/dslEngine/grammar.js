...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c62 = /^[.s]/,
      peg$c63 = peg$classExpectation([".", "s"], false, false),
      ...
      peg$c71 = "Create if not exists",
      peg$c72 = peg$literalExpectation("Create if not exists", false),
      peg$c73 = function(oneOnly, type, where, as, joins, createIfNeeded) {
            if (as && as.endsWith('.')) {
      ...
      peg$c74 = "Join from",
      peg$c75 = peg$literalExpectation("Join from", false),
      peg$c76 = function(joinType) {
          return {
            joins: joinType
          }
        },
      peg$c77 = " where ",
      peg$c78 = peg$literalExpectation(" where ", false),
      peg$c79 = function(json) {
            return json
          },
      peg$c80 = " ",
      ...
      peg$c86 = /^[*._\-]/,
      peg$c87 = peg$classExpectation(["*", ".", "_", "-"], false, false),
      peg$c88 = function(w) {
