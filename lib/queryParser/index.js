...
const executeUpdate = (instruction, executionContext) => {
  executionContext = _.cloneDeep(executionContext)
  ...
  debug(val(instruction.doc, executionContext), JSON.stringify(updateInstruction), JSON.stringify(executionContext))
}
