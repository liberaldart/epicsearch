...
statement
  = get / search / async / index / link / unlink/ booleanExpression / assignment / unset / iterate 
...
iterate
  = 'iterate over' index:word as:as? space? '.'? [G/g] 'et' space+ size:word space+ 'at a time' '.'? {
    return {
