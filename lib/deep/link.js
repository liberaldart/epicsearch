...
const makeLink = (e1, e1ToE2Relation, e2, cache, isOwn) => {
  ...
  .then((isAlreadyLinked) => {
    if (isAlreadyLinked) {//Don't need to link
      //debug('already linked but applying inbound update from e2. E1', e1._type, 'e1ToE2Relation', e1ToE2Relation, 'e2', e2._type)
      return inboundGraphUpdater.execute(cache, e1, [e1ToE2Relation, e2._id], e2, unionCalculator.updateLeftNode)
    } else {
