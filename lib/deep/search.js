...
Search.prototype.execute = function(params) {

  return this.es.search(query(params))
    .then(function(res) {
...
function query(params) {
  ...
  var toFetchFields = fields || fieldsToFetch.forEntities(this.es.config.entityTypes, params.context, params.lang)
...
function toQueryFields(entityType, lang) {
  ...
  var entitySchema = this.config.schema[entityType]
