module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c2 = function(relationAB, relationBA, connectedEntities) {
            return {
              aToBName: relationAB,
              bToAName: relationBA,
        ...
        peg$c3 = function(entityA, entityB) {
        ...
        peg$c4 = /^[*._\-]/,
        peg$c5 = { type: "class", value: "[\\*\\._-]", description: "[\\*\\._-]" },
        peg$c6 = function(w) {
    ...
    function peg$parsestart() {
      ...
      s0 = peg$parserelationsDef();

      return s0;
    }

    function peg$parserelationsDef() {
      var s0, s1;

      s0 = [];
      s1 = peg$parserelationDef();
      if (s1 !== peg$FAILED) {
        while (s1 !== peg$FAILED) {
          s0.push(s1);
          s1 = peg$parserelationDef();
    ...
    function peg$parseentityConnection() {
